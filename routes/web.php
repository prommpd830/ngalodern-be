...
Route::group(['middleware' => ['auth', 'verified']], function() {
    ...
    Route::post('/profile/cropImg', 'ProfileController@uploadCropImage')->name('profile.cropImg');
...
Route::group(['middleware' => ['auth', 'verified', 'editor.admin']], function(){
    ...
    // Route Delete Hasil Ujian
    Route::delete('/hasil/{id}/delete', 'ProfileController@hasilDestroy')->name('hasil.destroy');
});
...
Route::group(['middleware' => ['auth', 'verified', 'admin']], function(){
    ...
    // Route CRUD User
    Route::get('/user/{id}/create', 'Admin\UserController@create')->name('user.create');
    Route::post('/user/store', 'Admin\UserController@store')->name('user.store');
    Route::resource('/user', 'Admin\UserController')->except('index', 'show', 'create', 'store');
