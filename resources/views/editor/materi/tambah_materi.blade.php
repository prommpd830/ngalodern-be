        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
              ...
              <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Tambah Materi</h3>
              </div>
              <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show" meth>
              <!--begin::Form-->
              <form class="form" method="POST" action="{{ route('materi.store') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                  <div class="alert alert-warning mb-4" role="alert">
                    <p class="text-dark fw-bold"><h3>Note</h3>Untuk (Materi Yang Terkait) jika tidak memilih materi apapun, Maka sistem akan otomatis membuatkan materi baru dengan bahasa yang telah dipilih.</p>
                  </div>
                        ...
                        <div class="row fv-row">
                            ...
                            <div class="col-6">
                                ...
                                <label class="d-flex flex-row cursor-pointer">
                                    ...
                                    <input class="form-check-input" type="radio" name="id_bahasa" value="{{ $data->id }}">
                                    </span>
                                    <!--end:Input-->
                                    <!--begin:Label-->
                ...
                <!--end::Input group-->
                  ...
                  <!--begin::Input group-->
                    <div class="fv-row mb-8 mx-lg-10">
                        ...
                        <!--begin::Input-->
                        <div class="fv-row">
                            <select name="kode_materi" class="form-select form-select-solid" data-control="select2">
                  ...
                  <!--begin::Input group-->
                    <div class="fv-row mb-8 mx-lg-10">
                        ...
                        <!--begin::Input-->
                        <div class="fv-row">
                            <input type="text" id="materi" name="materi" class="form-control form-control-lg form-control-solid" placeholder="Nama Materi" value="{{ old('materi') }}">
                            @error('materi')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
