  ...
  <div class="card-toolbar align-items-start">
    ...
    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
      ...
      <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
          <a href="{{route('materi.create')}}" class="menu-link px-3">Tambah Materi</a>
        </div>
        <!--end::Menu item-->
      </div>
      <!--end::Menu-->
    ...
    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="kt_datatable_example_5">
      ...
      <tbody class="text-gray-600 fw-bold">
        ...
        <tr class="text-center">
          ...
          <!--begin::Role=-->
          <td class="text-start">{{ $item->materi }}</td>
          <!--end::Role=-->
          <!--begin::Two step=-->
          <td>
          ...
          <td>
            <div class="d-flex justify-content-center flex-shrink-0">
              <a href="/submateri/{{ $item->id }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Daftar Submateri">
              <!--begin::Svg Icon | path: assets/media/icons/duotone/Communication/More.svg-->
              ...
              <a href="{{ route('materi.edit', $item->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Edit Materi">
