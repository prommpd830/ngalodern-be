  ...
  <div class="card-toolbar align-items-start">
    ...
    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
      ...
      <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
        ...
        <!--begin::Menu item-->
        <div class="menu-item px-3">
          <a href="{{ route('latihan.create') }}" class="menu-link px-3">Tambah Latihan</a>
        </div>
      </div>
      <!--end::Menu-->
    </div>
    ...
    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="kt_datatable_example_5">
      ...
      <thead>
        ...
        <tr class="text-center text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
          ...
          <th class="min-w-125px">Soal Latihan</th>
          <th class="min-w-80px">Level</th>
          <th class="min-w-100px">Materi</th>
          <th class="min-w-100px">Pelajaran</th>
          <th class="min-w-100px">Bahasa</th>
          <th class="min-w-100px">Aksi</th>
          <th class="min-w-100px">Status</th>
          <th class="min-w-80px">Jumlah Soal</th>
          <th class="min-w-80px">Total Nilai</th>
        </tr>
        <!--end::Table row-->
      </thead>
      <!--end::Table head-->
      ...
      <tbody class="text-gray-600 fw-bold">
        ...
        <tr class="text-center">
          ...
          <!--begin::Last login=-->
          <td>
            <div class="badge badge-light-primary fw-bolder text-capitalize">{{ $item->level->level }}</div>
          </td>
          <!--end::Last login=-->
          <!--begin::Two step=-->
          <td>
            <div class="badge badge-light-primary fw-bolder text-capitalize">{{ $item->materi->materi }}</div>
          </td>
          <!--end::Two step=-->
          <!--begin::Joined-->
          <td>
            <div class="badge badge-light-primary fw-bolder text-capitalize">{{ $item->mapel->mapel }}</div>
          </td>
          <!--begin::Joined-->
          <!--begin::Joined-->
          <td>
            <div class="badge badge-light-danger fw-bolder text-capitalize">{{ $item->bahasa->bahasa }}</div>
          </td>
          <!--begin::Joined-->
          <!--begin::Action=-->
          <td>
            <div class="d-flex justify-content-end flex-shrink-0">
              ...
              <a href="latihan/{{ $item->id }}/edit" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Edit Latihan">
              ...
              <form action="{{ route('latihan.destroy', $item->id) }}" method="post">
