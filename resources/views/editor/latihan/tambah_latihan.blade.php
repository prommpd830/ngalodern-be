        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse" data-bs-target="#kt_account_profile_details" aria-expanded="true" aria-controls="kt_account_profile_details">
              ...
              <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Tambah Latihan</h3>
              </div>
              <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="kt_account_profile_details" class="collapse show" meth>
              <!--begin::Form-->
              <form class="form" method="POST" action="{{ route('latihan.store') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Card body-->
                ...
                <!--end::Input group-->
                  ...
                  <!--begin::Input group-->
                    <div class="fv-row mb-8 mx-lg-10">
                        ...
                        <!--begin::Input-->
                        <div class="fv-row">
                            <select name="id_materi" class="form-select form-select-solid" data-control="select2">
                  ...
                  <!--begin::Input group-->
                    <div class="fv-row mb-8 mx-lg-10">
                        ...
                        <!--begin::Input-->
                        <div class="fv-row">
                            <input type="text" id="tes" name="tes" class="form-control form-control-lg form-control-solid" placeholder="Latihan kata, latihan frasa..." value="{{ old('tes') }}">
                            @error('tes')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
